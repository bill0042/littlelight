...
class _SubClassImageWidgetState extends DestinyItemState<SubClassImageWidget> with ProfileConsumerState{
  String imagePath;
  bool loaded = false;
  ...
  getDefinitions() async {
    var talentGridDef =
        await manifest.getDefinition<DestinyTalentGridDefinition>(
