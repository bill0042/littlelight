...
class GearTierFilterWidget extends BaseDrawerFilterWidget<GearTierFilterOptions> {
  @override
  Widget buildTitle(BuildContext context) {
    return Text("Gear Tier".translate(context).toUpperCase());
  }

  @override
  Widget buildOptions(BuildContext context, GearTierFilterOptions data) {
